    ...
    */
    ...
    'defaults' => [
        'produtos' => [
            ...
            'queue' => ['default', 'search-sync'],
            'balance' => 'auto',
            'autoScalingStrategy' => 'time',
            'maxProcesses' => (int) env('HORIZON_DEFAULT_MAX_PROCESSES', 5),
            'maxTime' => 0,
            'maxJobs' => 0,
            'memory' => (int) env('HORIZON_MEMORY_LIMIT', 256),
    ...
    'environments' => [
        ...
        'staging' => [
            'produtos' => [
                ...
                'minProcesses' => (int) env('HORIZON_STAGING_MIN_PROCESSES', 1),
            ],
        ],
        ...
        'local' => [
            'produtos' => [
                ...
                'minProcesses' => (int) env('HORIZON_LOCAL_MIN_PROCESSES', 1),
            ],
        ],
    ],
];
